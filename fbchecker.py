...
import requests,mechanize,pyfiglet
#
reload(sys)
...
br.addheaders = [('User-Agent', 'facebookexternalhit/1.1 (+http://www.facebook.com/externalhit_uatext.php)')]
...
def ban():
	os.system('clear')
	print R+'\x1b[1;97m\xe2\x95\x94' + 60 * '\xe2\x95\x90'
	banner = pyfiglet.figlet_format("     FB Checker")
	print R+banner
	print W+'   Author        :                                  Ely ID'
	print '   Kontak Author :                                  xxxxxx'
	print '   Github        :                github.com/elyID/fbcheck'
	print '\x1b[1;97m\xe2\x95\x9a' + 60 * '\xe2\x95\x90'+W
...
#		emil = a['email']
#		n.append(a['name'])
		print '\x1b[1;97m\xe2\x95\x94' + 60 * '\xe2\x95\x90'
    		print '\xe2\x95\x91\x1b[1;91m[\x1b[1;96m\xe2\x9c\x93\x1b[1;91m]\x1b[1;97m Halo \x1b[1;91m: \x1b[1;92m' + name
    		print '\x1b[1;97m\xe2\x95\x9a' + 60 * '\xe2\x95\x90'
...
#     		print '\x1b[1;37;40m4. Lainnya....       '
	  	...
	  	ban()
		print '\x1b[1;97m\xe2\x95\x94' + 60 * '\xe2\x95\x90'
                print '\xe2\x95\x91\x1b[1;91m[\x1b[1;96m\xe2\x9c\x93\x1b[1;91m]\x1b[1;97m Halo \x1b[1;91m: \x1b[1;92m Anonimous'
                print '\x1b[1;97m\xe2\x95\x9a' + 60 * '\xe2\x95\x90'
                print '\x1b[1;37;40m1. Informasi Pengguna'
                print '\x1b[1;37;40m2. Hack Akun Facebook'
#               print '\x1b[1;37;40m3. Bot               '
...
def get(data):
	...
	try:
		...
		print (R +'[!] Login gagal')
		print '[!] cek lagi user dan password fb anda dg benar'
...
# pilihan no 5 logout menghapus akses token/logout
	 	...
	 	ban()
		print 'Yakin mau Logout?'
		a = raw_input("[!] ketik 'ok' untuk melanjutkan : ")
		if a.lower() == 'ok':
			try:
				os.system('rm -rf tes/token.log')
